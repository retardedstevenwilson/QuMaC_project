import console_2_toolkit as Q
import time

#set all timescales in seconds
arduino=Q.ArduinoConnector_console('COM6')
...
buffervolume=Q.pgauge_console(name='buffervolume',port='COM3') #change comport to 5 for madhavi's laptop
mainchamber=Q.pgauge_console(name='mainchamber',port='COM7')
loadlock=Q.pgauge_console(name='loadlock',port='COM4')
